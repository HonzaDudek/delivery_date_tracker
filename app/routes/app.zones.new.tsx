...
export default function NewZone() {
  ...
  const [transitDaysMin, setTransitDaysMin] = useState("3");
  const [transitDaysMax, setTransitDaysMax] = useState("5");
            ...
            <Card>
              <FormLayout>
                <TextField
                  ...
                  onChange={setName}
                  autoComplete="off"
                  placeholder="e.g., Domestic US, Canada, Europe"
                  requiredIndicator
                />
                <TextField
                  label="Countries"
                ...
                <TextField
                  ...
                  helpText="Optional: narrow the zone to specific regions"
                />
              </FormLayout>
            </Card>
          </Layout.AnnotatedSection>
